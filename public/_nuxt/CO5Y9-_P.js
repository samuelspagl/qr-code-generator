import{E as v,F as h,ag as g,a8 as o,aq as I,Q as y,x as c,y as p,z as m,a9 as u,aa as k,a4 as w,a3 as T,A as f,ab as S}from"./C7As8BTR.js";var x=v`
    .p-steps {
        position: relative;
    }
...
`,P={root:function(e){var t=e.props;return["p-steps p-component",{"p-readonly":t.readonly}]},list:"p-steps-list",item:function(e){var t=e.instance,r=e.item,l=e.index;return["p-steps-item",{"p-steps-item-active":t.isActive(l),"p-disabled":t.isItemDisabled(r,l)}]},itemLink:"p-steps-item-link",itemNumber:"p-steps-item-number",itemLabel:"p-steps-item-label"},L=h.extend({name:"steps",style:x,classes:P}),D={name:"BaseSteps",extends:g,props:{id:{type:String},model:{type:Array,default:null},readonly:{type:Boolean,default:!0},activeStep:{type:Number,default:0}},style:L,provide:function(){return{$pcSteps:this,$parentInstance:this}}},F={name:"Steps",extends:D,inheritAttrs:!1,emits:["update:activeStep","step-change"],data:function(){return{d_activeStep:this.activeStep}},watch:{activeStep:function(e){this.d_activeStep=e}},mounted:function(){var e=this.findFirstItem();e&&(e.tabIndex="0")},methods:{getPTOptions:function(e,t,r){return this.ptm(e,{context:{item:t,index:r,active:this.isActive(r),disabled:this.isItemDisabled(t,r)}})},onItemClick:function(e,t,r){if(this.disabled(t)||this.readonly){e.preventDefault();return}t.command&&t.command({originalEvent:e,item:t}),r!==this.d_activeStep&&(this.d_activeStep=r,this.$emit("update:activeStep",this.d_activeStep)),this.$emit("step-change",{originalEvent:e,index:r})},onItemKeydown:function(e,t){switch(e.code){case"ArrowRight":{this.navigateToNextItem(e.target),e.preventDefault();break}case"ArrowLeft":{this.navigateToPrevItem(e.target),e.preventDefault();break}case"Home":{this.navigateToFirstItem(e.target),e.preventDefault();break}case"End":{this.navigateToLastItem(e.target),e.preventDefault();break}case"Tab":break;case"Enter":case"NumpadEnter":case"Space":{this.onItemClick(e,t),e.preventDefault();break}}},navigateToNextItem:function(e){var t=this.findNextItem(e);t&&this.setFocusToMenuitem(e,t)},navigateToPrevItem:function(e){var t=this.findPrevItem(e);t&&this.setFocusToMenuitem(e,t)},navigateToFirstItem:function(e){var t=this.findFirstItem(e);t&&this.setFocusToMenuitem(e,t)},navigateToLastItem:function(e){var t=this.findLastItem(e);t&&this.setFocusToMenuitem(e,t)},findNextItem:function(e){var t=e.parentElement.nextElementSibling;return t?t.children[0]:null},findPrevItem:function(e){var t=e.parentElement.previousElementSibling;return t?t.children[0]:null},findFirstItem:function(){var e=y(this.$refs.list,'[data-pc-section="item"]');return e?e.children[0]:null},findLastItem:function(){var e=I(this.$refs.list,'[data-pc-section="item"]');return e?e[e.length-1].children[0]:null},setFocusToMenuitem:function(e,t){e.tabIndex="-1",t.tabIndex="0",t.focus()},isActive:function(e){return e===this.d_activeStep},isItemDisabled:function(e,t){return this.disabled(e)||this.readonly&&!this.isActive(t)},visible:function(e){return typeof e.visible=="function"?e.visible():e.visible!==!1},disabled:function(e){return typeof e.disabled=="function"?e.disabled():e.disabled},label:function(e){return typeof e.label=="function"?e.label():e.label},getMenuItemProps:function(e,t){var r=this;return{action:o({class:this.cx("itemLink"),onClick:function(s){return r.onItemClick(s,e)},onKeyDown:function(s){return r.onItemKeydown(s,e)}},this.getPTOptions("itemLink",e,t)),step:o({class:this.cx("itemNumber")},this.getPTOptions("itemNumber",e,t)),label:o({class:this.cx("itemLabel")},this.getPTOptions("itemLabel",e,t))}}}},N=["id"],A=["aria-current","onClick","onKeydown","data-p-active","data-p-disabled"];function C(i,e,t,r,l,s){return p(),c("nav",o({id:i.id,class:i.cx("root")},i.ptmi("root")),[m("ol",o({ref:"list",class:i.cx("list")},i.ptm("list")),[(p(!0),c(u,null,k(i.model,function(n,a){return p(),c(u,{key:s.label(n)+"_"+a.toString()},[s.visible(n)?(p(),c("li",o({key:0,class:[i.cx("item",{item:n,index:a}),n.class],style:n.style,"aria-current":s.isActive(a)?"step":void 0,onClick:function(d){return s.onItemClick(d,n,a)},onKeydown:function(d){return s.onItemKeydown(d,n,a)}},{ref_for:!0},s.getPTOptions("item",n,a),{"data-p-active":s.isActive(a),"data-p-disabled":s.isItemDisabled(n,a)}),[i.$slots.item?(p(),T(S(i.$slots.item),{key:1,item:n,index:a,active:a===l.d_activeStep,label:s.label(n),props:s.getMenuItemProps(n,a)},null,8,["item","index","active","label","props"])):(p(),c("span",o({key:0,class:i.cx("itemLink")},{ref_for:!0},s.getPTOptions("itemLink",n,a)),[m("span",o({class:i.cx("itemNumber")},{ref_for:!0},s.getPTOptions("itemNumber",n,a)),f(a+1),17),m("span",o({class:i.cx("itemLabel")},{ref_for:!0},s.getPTOptions("itemLabel",n,a)),f(s.label(n)),17)],16))],16,A)):w("",!0)],64)}),128))],16)],16,N)}F.render=C;export{F as default};
